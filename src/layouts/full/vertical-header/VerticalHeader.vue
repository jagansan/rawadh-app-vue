...
<template>
  <v-app-bar elevation="0" height="80" class="header__element">
    <v-btn
      class="hidden-md-and-down text-secondary toogle__icon"
      icon
      rounded="sm"
      variant="flat"
    ...
    <!-- <v-btn
      class="hidden-lg-and-up text-secondary ms-3 toogle__icon"
    ...
    <!-- search mobile -->
    <v-btn
      class="hidden-lg-and-up text-secondary ml-3 toogle__icon"
      color="lightsecondary"
      icon
      rounded="sm"
      variant="flat"
    ...
    <v-sheet class="d-none d-lg-block header__menu">
      <RouterLink to="/imageeditor">Image Editor</RouterLink>
    </v-sheet>
    <v-sheet class="d-none d-lg-block header__menu">
